...
import com.ihave.async.callback.DefaultGroupCallback;
import com.ihave.async.callback.IGroupCallback;
...
public class Async {
    public static final ThreadPoolExecutor COMMON_POOL =
            new ThreadPoolExecutor(Runtime.getRuntime().availableProcessors(), 1024,

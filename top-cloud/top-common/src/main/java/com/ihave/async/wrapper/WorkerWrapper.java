package com.ihave.async.wrapper;

import com.ihave.async.callback.DefaultCallback;
import com.ihave.async.callback.ICallback;
import com.ihave.async.callback.IWorker;
import com.ihave.async.exception.SkippedException;
import com.ihave.async.executor.timer.SystemClock;
import com.ihave.async.worker.DependWrapper;
import com.ihave.async.worker.ResultState;
